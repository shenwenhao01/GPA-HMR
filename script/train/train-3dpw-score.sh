...
srun -p ${PARTITION} \
    ...
    -o /mnt/AFS_shenwenhao/ScoreHypo/train-3dpw-score.log \
    ${SRUN_ARGS} \
    ...
    /mnt/AFS_shenwenhao/.conda/envs/py38/bin/python \
        ...
        main/main.py \
        --config config/train/scorenet/3dpw.yaml \
        --exp experiment/scorenet \
        --doc 3dpw \
        --batch_size 64"

# torchrun --nproc_per_node=2 --master_port=23452 main/main.py --config config/train/scorenet/3dpw.yaml --exp experiment/scorenet --doc 3dpw