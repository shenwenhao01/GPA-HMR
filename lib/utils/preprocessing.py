...
from utils.transforms_humandata import cam2pixel, transform_joint_to_other_db
...
def process_bbox(bbox, img_width, img_height, ratio=1.25):
    '''
    保持检测框中心点位置不变调整检测框比例为cfg.input_img_size

    ration: 扩大检测框大小'''
    # [DEBUG] input img shape different from smpler-x
