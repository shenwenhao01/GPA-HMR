...
from utils.transforms_humandata import transform_joint_to_other_db

import pickle

class SMPLX(object):
    def __init__(self):
        self.human_model_path = '/mnt/hdd1/shenwenhao/human_model_files/'
        ...
        self.layer = {'neutral': smplx.create(self.human_model_path, 'smplx', gender='NEUTRAL', use_pca=False, use_face_contour=True, **self.layer_arg),
                        ...
                        'female': smplx.create(self.human_model_path, 'smplx', gender='FEMALE', use_pca=False, use_face_contour=True, **self.layer_arg)
                        }
        self.layer_arg['flat_hand_mean'] = True
        self.layer_flat_hand_mean = {
                        'neutral': smplx.create(self.human_model_path, 'smplx', gender='NEUTRAL', use_pca=False, use_face_contour=True, **self.layer_arg),
                        'male': smplx.create(self.human_model_path, 'smplx', gender='MALE', use_pca=False, use_face_contour=True, **self.layer_arg),
                        'female': smplx.create(self.human_model_path, 'smplx', gender='FEMALE', use_pca=False, use_face_contour=True, **self.layer_arg)
                    }
...
class MANO(object):
    def __init__(self):
        ...
        self.layer = {'right': smplx.create(self.human_model_path, 'mano', is_rhand=True, use_pca=False, flat_hand_mean=False, **self.layer_arg), 'left': smplx.create(self.human_model_path, 'mano', is_rhand=False, use_pca=False, flat_hand_mean=False, **self.layer_arg)}
        self.vertex_num = 778
