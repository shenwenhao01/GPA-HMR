...
class MixDataset(data.Dataset):
    ...
    def __init__(self,
        ...
        self.tot_size = int(max(self._subset_size) * 0.25)
    ...
    def __getitem__(self, idx):
        ...
        img, target, img_id, bbox, img_path = self._subsets[dataset_idx][sample_idx]
        list_smpl = [0,1,3,4,5,6,7]         # [DEBUG]
        list_no_smpl = [2]
